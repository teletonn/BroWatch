...
- [01 — Обзор и гайд](01-obzor.md) — что это, железо, детекции, SquachMesh, прошивка и настройка.
- `02-rusifikaciya.md` — (план) двуязычный режим RU/EN, шрифты, строки.
- `03-web-most.md` — (план) шлюз USB/Serial + `browatch-web` на порту 40400.
- `04-android.md` — (план) `browatch-app` (Native Kotlin + BLE).
