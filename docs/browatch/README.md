...
## Внешние доки (для GitHub)

- [README](../../README.md) — главная страница проекта на русском.
- [docs/IDEOLOGIYA.md](../IDEOLOGIYA.md) — зачем проект, ценности, школы и игры.
- [docs/ROADMAP.md](../ROADMAP.md) — LoRa, веб, нативные приложения.
- [docs/GAJD.md](../GAJD.md) — гайд по использованию.
